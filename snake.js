...
// Module pattern
// Modules are like classes in Java
...
var paint = function () {
   ...
   */
   ...
   If the checkCollision is true, it means the the snake has crashed on its body itself, then the game will be stopped again. 
   */
...
// kind of acts like a constructor for the draw module function
var init = function () {
     direction = 'down';
     drawSnake();
     createFood();
	 
	 // calls paint() every 80 ms
     gameloop = setInterval(paint, 80);
	 
 }

 // Creates a new init object using the init function
 return {
     init: init // field init take value of init function
 };
